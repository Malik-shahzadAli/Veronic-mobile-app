...
@Component({
  ...
  templateUrl: './other-address.page.html',
  styleUrls: ['./other-address.page.scss'],
})
export class OtherAddressPage implements OnInit {
  ...
  getUserAddressNextClick() {
    ...
    this.http.post(this.url + '/api/validate/address', {"streetAddress" : address})
      .subscribe((response) => {
        ...
        console.log(response);
        this.finalObj.quoteData.customer.customerData.postalAddress.street = streetAddress;
        this.finalObj.quoteData.customer.customerData.postalAddress.zip = zipCode;
        this.finalObj.quoteData.customer.customerData.postalAddress.city = city;
        this.finalObj.quoteData.customer.customerData.postalAddress.state = state;
        console.log(this.finalObj)
        this.router.navigate(['/other-contect-info']);
      },
      (error) => {
        this.loadingController.dismiss('login');
        this.getstreetError();
