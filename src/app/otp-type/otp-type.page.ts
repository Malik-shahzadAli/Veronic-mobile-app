...
@Component({
  ...
  templateUrl: './otp-type.page.html',
  styleUrls: ['./otp-type.page.scss'],
})
export class OtpTypePage implements OnInit {
  public finalObj;
  ...
  getUserHomeOwnerStatusNextClick() {
    ...
    let newPhone = this.finalObj.customer.customerData.phone;
